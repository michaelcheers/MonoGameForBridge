...
namespace Microsoft.Xna.Framework.Input
{
    ...
    public static class GamePad
    {
        ...
        {
            if (index < 0 || index >= MaximumGamePadCount)
                return GamePadState.Default;
            
            return /*PlatformGetState(index, deadZoneMode)*/new GamePadState();
        }
        ...
        public static bool SetVibration(int index, float leftMotor, float rightMotor)
        {
            ...
            return /*PlatformSetVibration(index, MathHelper.Clamp(leftMotor, 0.0f, 1.0f), MathHelper.Clamp(rightMotor, 0.0f, 1.0f))*/false;
        }
